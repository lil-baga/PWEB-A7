                ...
                <div class="h-[570px] overflow-y-auto overflow-x-hidden">
                    <table class="w-full text-xs text-left rtl:text-right text-slate-500 border border-slate-300">
                        ...
                        <tbody>
                            <?php if (isset($sempro)) :
                                foreach ($sempro as $s) :
                                    if ($s['recorded_at'] == NULL && $s['deleted_at'] == NULL) : ?>
                                                    ...
                                                    <form action="<?= urlpath("editsempro?id=" . $s['id']); ?>" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="grid gap-6 mt-4 mb-4 grid-cols-2">
                                                            ...
                                                            <div class="col-span-2">
                                                                ...
                                                                <textarea id="judul" name="judul" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Judul Proposal Skripsi"><?php echo $s['judul']; ?></textarea>
                                                            </div>
                                                            <div class="col-span-2">
                ...
                <div class="relative bg-white rounded-lg shadow p-4">
                    ...
                    <form action="<?= urlpath('addsempro') ?>" method="POST">
                        <div class="grid gap-6 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                <label for="judul" class="block mb-2 text-sm font-medium text-gray-900">Judul</label>
                                <textarea id="judul" name="judul" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Judul Proposal Skripsi"></textarea>
                            </div>
                            <div class="col-span-2">
                                <label for="tanggal" class="block mb-2 text-sm font-medium text-gray-900">Tanggal</label>
                                <input type="datetime-local" id="tanggal" name="tanggal" class="p-2 w-96 resize-none border-none align-top focus:ring-0 sm:text-sm" rows="4" placeholder="Tanggal" min='.date("Y-m-d H:i")' />
                            </div>
                            <div class="col-span-1 mb-2">
                                <div class="col-span-1">
                                    <label for="pembahas1_id" class="block mb-2 text-sm font-medium text-gray-900">Dosen Pembahas 1</label>
