<body>
    ...
    ?>
    <div class="flex flex-row items-center justify-center w-screen h-full py-4 px-8">
        <div class="flex flex-col">
            <div class="p-4 text-lg font-semibold text-left rtl:text-right text-slate-900 bg-white mb-4">
                ...
                <?php else : ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <div class="max-w-md mx-auto mt-6 mb-4 gap-64">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow p-4">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                            <h3 class="text-lg font-semibold text-gray-900">
                                                                Tambahkan Link Proposal, Zoom, dan Record
                                                            </h3>
                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="modal-link-<?php echo $s['id']; ?>">
                                                        ...
                                                        <!-- Modal AddRecord -->
                                                        <form action="<?= urlpath("addlink?id=" . $s['id']) ?>" method="POST">
                                                            <input hidden type="number" name="id" id="id" value="<?php echo $s['id']; ?>" class="hidden bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5" required="">
                                                            <div class="grid gap-6 mt-4 mb-4 grid-cols-2">
                                                                <div class="col-span-2">
                                                                    <label for="link_proposal" class="block mb-2 text-sm font-medium text-gray-900">Link Proposal</label>
                                                                    <input type="text" name="link_proposal" id="link_proposal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Link Drive Proposal" required="">
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="link_zoom" class="block mb-2 text-sm font-medium text-gray-900">Link Zoom</label>
                                                                    <input type="text" name="link_zoom" id="link_zoom" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Link Zoom" required="">
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="link_record" class="block mb-2 text-sm font-medium text-gray-900">Link Record</label>
                                                                    <input type="text" name="link_record" id="link_record" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Link Record Sempro" required="">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="relative p-4 w-full max-w-4xl max-h-full">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow p-4">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                            ...
                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="modal-edit-<?php echo $s['id']; ?>">
                                                                <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                                </svg>
                                                                <span class="sr-only">Close modal</span>
                                                        ...
                                                        <form action="<?= urlpath("editsempro?id=" . $s['id']); ?>" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="grid gap-6 mt-4 mb-4 grid-cols-2">
                                                                <div class="col-span-2">
                                                                    ...
                                                                    <input type="text" name="nama" id="nama" value="<?php echo $s['nama']; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nama Mahasiswa" required="">
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="nim" class="block mb-2 text-sm font-medium text-gray-900">NIM</label>
                                                                    <input type="text" name="nim" id="nim" value="<?php echo $s['nim']; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="NIM" required="">
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="judul" class="block mb-2 text-sm font-medium text-gray-900">Judul</label>
                                                                    <textarea id="judul" name="judul" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 resize-none" placeholder="Judul Proposal Skripsi"><?php echo $s['judul']; ?></textarea>
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="tanggal" class="block mb-2 text-sm font-medium text-gray-900">Tanggal</label>
                                                                    <input type="datetime-local" id="tanggal" value="<?php echo $s['tanggal']; ?>" name="tanggal" class="p-2 w-96 resize-none border-none align-top focus:ring-0 sm:text-sm" rows="4" placeholder="Tanggal" min='date("Y-m-d H:i")' required="" />
                                                                </div>
                                                                <div class="col-span-1 mb-2">
                                                                    <div class="col-span-1">
                                                                        <label for="pembahas1_id" class="block mb-2 text-sm font-medium text-gray-900">Dosen Pembahas 1</label>
                                                                        <select id="pembahas1_id" name="pembahas1_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-96 p-2.5">
                                                                    ...
                                                                    <br>
                                                                    <div class="col-span-1">
                                                                        <label for="pembimbing1_id" class="block mb-2 text-sm font-medium text-gray-900">Dosen Pembimbing 1</label>
                                                                        <select id="pembimbing1_id" name="pembimbing1_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-96 p-2.5">
                                                                ...
                                                                <div class="col-span-1">
                                                                    <div class="col-span-1">
                                                                        <label for="pembahas2_id" class="block mb-2 text-sm font-medium text-gray-900"> Dosen Pembahas 2</label>
                                                                        <select id="pembahas2_id" name="pembahas2_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-96 p-2.5">
                                                                    ...
                                                                    <br>
                                                                    <div class="col-span-1">
                                                                        <label for="pembimbing2_id" class="block mb-2 text-sm font-medium text-gray-900"> Dosen Pembimbing 2</label>
                                                                        <select id="pembimbing2_id" name="pembimbing2_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-96 p-2.5">
                    ...
                    <div class="relative bg-white rounded-lg shadow p-4">
                        ...
                        <form action="<?= urlpath('addsempro') ?>" method="POST">
                            <div class="grid gap-6 mt-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    <label for="nim" class="block mb-2 text-sm font-medium text-gray-900">NIM</label>
                                    <input type="text" name="nim" id="nim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="NIM" required="">
                                </div>
                                <div class="col-span-2">
                                    <label for="judul" class="block mb-2 text-sm font-medium text-gray-900">Judul</label>
                                    <textarea id="judul" name="judul" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 resize-none" placeholder="Judul Proposal Skripsi"></textarea>
                                </div>
                                <div class="col-span-2">
                                    <label for="tanggal" class="block mb-2 text-sm font-medium text-gray-900">Tanggal</label>
                                    <input type="datetime-local" id="tanggal" name="tanggal" class="p-2 w-96 resize-none border-none align-top focus:ring-0 sm:text-sm" rows="4" placeholder="Tanggal" min='.date("Y-m-d H:i")' required="" />
                                </div>
                                <div class="col-span-1 mb-2">
                                    <div class="col-span-1">
                                        <label for="pembahas1_id" class="block mb-2 text-sm font-medium text-gray-900">Dosen Pembahas 1</label>
