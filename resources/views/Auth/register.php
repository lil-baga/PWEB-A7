                ...
                <form action="<?=urlpath('register')?>" method="POST" enctype="multipart/form-data" class="flex flex-col w-full h-full mx-auto gap-8">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="number" id="username" name="username" class="remove-arrow rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-96 text-xl p-2.5" placeholder="Masukkan NRP">
                        </div>
                    </div>
                    <div>
